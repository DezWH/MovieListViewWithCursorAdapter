package com.bigranch.adroid.movielistviewwithcursoradapter;

/**
 * Created by Dez on 12/7/2017.
 */
...
public class DatabaseManager{
        ...
        //--------------------------------
        // Fetch all records, sorted by movie name
        //
...
public class SQLHelper extends SQLiteOpenHelper {
    ...
    //------------------------------------------------------
    // Database open, close, creation goes in here,
    //, for three's code to create a table.
    @Override
